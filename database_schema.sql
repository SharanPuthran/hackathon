...
CREATE TABLE aircraft_types (
    ...
    category ENUM('Widebody', 'Narrowbody') NOT NULL,
...
CREATE TABLE bookings (
    ...
    booking_class ENUM('Economy', 'Business', 'First') NOT NULL,
    seat_number VARCHAR(5) NULL,
    booking_status ENUM('Confirmed', 'CheckedIn', 'Boarded', 'NoShow', 'Cancelled') NOT NULL DEFAULT 'Confirmed',
...
CREATE TABLE baggage (
    ...
    baggage_type ENUM('CheckedIn', 'CarryOn', 'Sports', 'SpecialHandling') NOT NULL,
    weight_kg DECIMAL(5,2) NOT NULL CHECK (weight_kg > 0),
    is_priority BOOLEAN DEFAULT FALSE,
    current_location VARCHAR(3) NULL,
    final_destination VARCHAR(3) NOT NULL,
    baggage_status ENUM('CheckedIn', 'Loaded', 'InTransit', 'Arrived', 'Delayed', 'Lost') NOT NULL DEFAULT 'CheckedIn',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE commodity_types (
    commodity_type_id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE cargo_shipments (
    ...
    shipment_status ENUM('Queued', 'Confirmed', 'Cancelled', 'InTransit', 'Delivered') NOT NULL DEFAULT 'Queued',
...
CREATE TABLE cargo_flight_assignments (
    ...
    loading_status ENUM('Planned', 'Loaded', 'Offloaded', 'Transferred') NOT NULL DEFAULT 'Planned',
...
CREATE TABLE crew_roster (
    ...
    roster_status ENUM('Assigned', 'Confirmed', 'Completed', 'Cancelled') NOT NULL DEFAULT 'Assigned',
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
